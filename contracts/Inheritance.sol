...
contract D is B, C {
    ...
    //override (B,C) means we want to override a method that ezists in two parents
    function foo() public pure override (B,C) returns (string memory) {
        // super is special keyword that is user to call functions in the parent contract
    return super.foo();
    }
}
